...
__all__ = [
    'DISPID_SPRuleFirstElement', 'WAVEFORMATEX', 'SVPNormal',
    'DISPID_SVEBookmark', 'SP_VISEME_4', 'SP_VISEME_16',
    'DISPID_SRGState', 'ISpRecognizer', 'ISpeechVoice',
    'SWPKnownWordPronounceable', 'SAFTGSM610_44kHzMono',
    'SpeechStreamSeekPositionType', 'SPPS_Unknown', 'SSTTTextBuffer',
    'SDTPronunciation', 'SRERecognition', 'DISPID_SOTId',
    'SPEI_TTS_BOOKMARK', 'SAFT48kHz8BitStereo', 'SPPHRASEPROPERTY',
    'SPFILEMODE', 'SAFT16kHz8BitStereo', 'SPSMF_SAPI_PROPERTIES',
    'SPRECOGNIZERSTATUS',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpRecognizer2', 'SpSharedRecoContext',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpNotifyTranslator',
    'SpeechEngineConfidence', 'DISPID_SVRate', 'ISpNotifySink',
    'SpeechPropertyAdaptationOn', 'DISPID_SRCSetAdaptationData',
    'SpeechAudioFormatGUIDWave', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SPPHRASE', 'DISPID_SDKDeleteValue', 'SPSInterjection',
    'DISPID_SLPPhoneIds', 'SGRSTTRule', 'DISPID_SPCPhoneToId',
    'DISPID_SGRsCommitAndSave', 'DISPID_SWFEChannels',
    'DISPID_SLWsItem', 'DISPID_SpeechGrammarRules', 'tagSTATSTG',
    'SPAR_Medium', 'ISpeechRecoContext', 'eLEXTYPE_USER_SHORTCUT',
    'ISpRecoGrammar2', 'SVSFUnusedFlags', 'SVF_Stressed',
    'DISPID_SLPPartOfSpeech', 'ISpeechPhraseAlternates',
    'DISPID_SRGCmdLoadFromResource', 'SPEI_UNDEFINED',
    'SpeechCategoryAppLexicons', 'DISPID_SpeechAudio',
    'DISPID_SPRuleChildren', 'DISPID_SGRsAdd',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SRCPause',
    'eLEXTYPE_PRIVATE18', 'SPFM_NUM_MODES', 'DISPID_SRCState',
    'SRTEmulated', 'tagSPPROPERTYINFO', 'SPTEXTSELECTIONINFO',
    'DISPID_SOTDisplayUI', 'ISpStream', 'SPEI_SR_AUDIO_LEVEL',
    'SPAO_RETAIN_AUDIO', 'SVSFIsXML', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SpeechBaseStream', 'SVSFPersistXML', 'SDTDisplayText',
    'DISPID_SOTCreateInstance', 'SPLO_STATIC',
    'DISPID_SVGetAudioOutputs', 'DISPID_SRCEEnginePrivate',
    'SpNotifyTranslator', 'SPPHRASERULE', 'SPFM_CREATE_ALWAYS',
    ...
    'ISpNotifySource', 'SpeechEngineProperties',
    'SAFTADPCM_8kHzStereo', 'DISPID_SPELexicalForm', 'ISpeechLexicon',
    'DISPID_SLWsCount', 'SpeechWordType', 'SPRECOSTATE',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SLWWord', 'SPWT_LEXICAL',
    'DISPID_SPRuleId', 'SpeechPropertyResponseSpeed', 'SVSFNLPMask',
    'ISpRecognizer3', 'SPCS_ENABLED', 'eLEXTYPE_PRIVATE6',
    'SPGS_ENABLED', 'SpeechTokenKeyAttributes', 'SPAUDIOOPTIONS',
    'DISPID_SRRPhraseInfo', 'DISPID_SRCERecognition',
    'DISPID_SPAsCount', 'SAFTADPCM_22kHzMono', 'SRADefaultToActive',
    'SPINTERFERENCE_TOOSLOW', 'SpeechPropertyResourceUsage',
    'SPEI_START_INPUT_STREAM', 'SVSFParseAutodetect', 'SRAImport',
    'eLEXTYPE_PRIVATE13', 'DISPID_SPPConfidence',
    'DISPID_SRGCmdSetRuleIdState', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SOTCGetDataKey', 'SpeechAudioVolume', 'SDKLCurrentConfig',
    'SVEAudioLevel', 'SPRS_ACTIVE', 'SPSModifier',
    'DISPID_SRIsUISupported', 'DISPID_SRGReset', 'SpSharedRecognizer',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SAFTDefault',
    'SAFTADPCM_44kHzStereo', 'DISPID_SDKEnumKeys',
    'DISPID_SRRecognizer', 'DISPID_SVPriority', 'DISPID_SGRsCommit',
    'DISPID_SRRSaveToMemory', 'SPEVENTENUM', 'SPSUnknown',
    'DISPID_SASCurrentDevicePosition', '__MIDL_IWinTypes_0009',
    'SGDSActive', 'SAFT24kHz8BitMono',
    'DISPID_SpeechPhraseProperties', 'SAFT22kHz16BitStereo',
    'DISPID_SLGetGenerationChange', 'DISPID_SRGSetTextSelection',
    'STSF_AppData', 'SREFalseRecognition', 'SPXRO_SML',
    'DISPID_SPIGetText', 'ISpeechGrammarRules', 'SpeechLexiconType',
    'SPCS_DISABLED', 'DISPID_SVVolume',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SRRAlternates',
    'SPSEMANTICERRORINFO', 'DISPID_SPRs_NewEnum', 'SVEEndInputStream',
    'SAFTGSM610_8kHzMono', 'ISpVoice',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPXMLRESULTOPTIONS', 'SAFT32kHz16BitStereo',
    'SPINTERFERENCE_NOSIGNAL', 'SASClosed', 'SPAUDIOSTATE',
    'SpeechAudioFormatGUIDText', 'DISPID_SDKGetStringValue',
    'SDTReplacement', 'SpeechRunState', 'DISPID_SRCCreateGrammar',
    'SVP_15', 'DISPID_SRCResume', 'SDA_Two_Trailing_Spaces',
    'SRSActiveAlways', 'ISpRecoContext2',
    'DISPID_SPANumberOfElementsInResult',
    'DISPID_SLGetPronunciations', 'ISpeechPhraseReplacements',
    'DISPID_SVSInputSentenceLength', 'SPBINARYGRAMMAR',
    'SECFIgnoreKanaType', 'DISPID_SRRAudioFormat',
    'ISpeechPhraseRules', 'DISPID_SVVoice', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SpeechLexiconWord', 'DISPID_SOTCSetId',
    'SPEI_VOICE_CHANGE', 'SITooSlow', 'SpeechCategoryPhoneConverters',
    'SVP_3', 'SRAORetainAudio', 'eLEXTYPE_USER',
    'SpeechVoicePriority', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SRRTTickCount', 'SAFT8kHz8BitMono', 'SECFIgnoreWidth',
    'ISpeechLexiconWord', 'SPEVENTSOURCEINFO', 'SVEViseme',
    'DISPID_SPEs_NewEnum', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SPPName', 'DISPID_SVSPhonemeId', 'DISPID_SRCESoundEnd',
    'DISPID_SGRName', 'DISPID_SRRRecoContext', 'SAFT11kHz8BitStereo',
    'SpAudioFormat', 'SSSPTRelativeToCurrentPosition',
    'SRERecoOtherContext', 'SAFT24kHz8BitStereo', 'SSTTWildcard',
    'SVSFlagsAsync', 'SECFDefault', 'SPPS_RESERVED2',
    'DISPID_SVEViseme', 'SAFT48kHz8BitMono',
    'DISPID_SpeechLexiconWords', 'DISPID_SRCEEndStream',
    'DISPID_SPIElements', 'DISPID_SVEWord', '_RemotableHandle',
    'STCRemoteServer', 'SPRST_ACTIVE_ALWAYS', 'DISPID_SVEStreamEnd',
    'SPSSuppressWord', 'DISPID_SRGetPropertyNumber', 'DISPID_SVSkip',
    'UINT_PTR', 'SVSFParseSapi', 'DISPID_SPIRetainedSizeBytes',
    'SAFTTrueSpeech_8kHz1BitMono', 'ISpMMSysAudio',
    'eLEXTYPE_PRIVATE15', 'SPSERIALIZEDRESULT',
    'SPEI_FALSE_RECOGNITION', 'SpUnCompressedLexicon', 'SPEVENT',
    'SPGS_DISABLED', 'SpeechRecognitionType',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SPSMF_SRGS_SAPIPROPERTIES', 'STSF_CommonAppData',
    'SPVOICESTATUS', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SpeechPhraseRule', 'SPBOOKMARKOPTIONS', 'DISPID_SLPsItem',
    'DISPID_SRGRules', 'SSFMCreate', 'SREStreamStart',
    'SAFT16kHz16BitMono', 'DISPID_SRGDictationLoad', 'SPFM_CREATE',
    'DISPID_SGRSTType', 'DISPID_SVEventInterests',
    'SPDKL_CurrentUser', 'DISPID_SABufferInfo', 'DISPID_SRRAudio',
    'SPPHRASEELEMENT', 'ISpPhraseAlt', 'SRTSMLTimeout',
    'SPEI_RESERVED5', 'SRSActive', 'SpeechLoadOption',
    'DISPID_SMSGetData', 'DISPID_SPRsCount', 'SpeechRecoContextState',
    'DISPID_SVSVisemeId', 'DISPID_SOTCategory',
    'DISPID_SPIReplacements', 'DISPID_SGRSTNextState', 'SP_VISEME_11',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SAEventHandle',
    'DISPID_SDKCreateKey', 'DISPID_SOTMatchesAttributes',
    'DISPID_SRGCmdLoadFromObject', 'SASStop', 'DISPID_SPCIdToPhone',
    'DISPID_SVSpeak', 'SWPUnknownWordUnpronounceable',
    'SpObjectTokenCategory', 'DISPID_SPIAudioSizeTime', 'SPAS_PAUSE',
    'DISPID_SRCEStartStream', 'SREBookmark', 'ISpObjectToken',
    'Speech_StreamPos_RealTime', 'LONG_PTR',
    'ISpeechGrammarRuleState', 'SpeechWordPronounceable',
    'DISPID_SCSBaseStream', 'DISPID_SpeechPhoneConverter',
    'DISPID_SPRuleParent', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SPRuleConfidence', 'DISPID_SREmulateRecognition',
    'SVP_18', 'DISPID_SPEAudioSizeTime', 'SLOStatic',
    'ISpeechPhraseRule', 'SpeechBookmarkOptions',
    'SPINTERFERENCE_NONE', 'Speech_Max_Pron_Length',
    'SPEI_REQUEST_UI', 'SRESoundEnd', 'DISPID_SRSetPropertyNumber',
    'ISpeechPhraseReplacement', 'DISPID_SVSpeakStream',
    'SpeechRecoEvents', 'DISPID_SASState',
    'ISpPhoneticAlphabetConverter', 'SpResourceManager',
    'DISPID_SpeechRecognizer', 'eLEXTYPE_PRIVATE16',
    'ISpeechPhraseProperties', 'SpWaveFormatEx', 'SpVoice',
    'DISPID_SpeechGrammarRule', 'DISPID_SWFESamplesPerSec',
    'SPDATAKEYLOCATION', 'DISPID_SDKSetStringValue',
    'SPSERIALIZEDPHRASE', 'SASPause', 'DISPID_SPILanguageId',
    'SPPS_Verb', 'DISPID_SGRsItem', 'SPEI_SOUND_START',
    'SAFTCCITT_uLaw_11kHzMono', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SVDisplayUI', 'eLEXTYPE_PRIVATE19',
    'DISPID_SWFEFormatTag', 'SpeechVoiceCategoryTTSRate',
    'SGDSInactive', 'ISpeechDataKey',
    ...
    'ISpeechObjectTokenCategory', 'ISpeechAudioStatus', 'SLODynamic',
    'DISPID_SABIMinNotification', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SDKGetlongValue', 'SRCS_Disabled', 'STCLocalServer',
    'ISpRecoGrammar', 'DISPID_SpeechObjectTokens',
    'SECFNoSpecialChars', 'ISpeechPhraseAlternate',
    'SPINTERFERENCE_TOOLOUD', 'SPSTREAMFORMATTYPE', 'SPPS_Noun',
    'eLEXTYPE_RESERVED4', 'DISPID_SpeechObjectToken',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SWFEBlockAlign', 'ISpObjectTokenCategory',
    'SREInterference', '_ISpeechRecoContextEvents',
    'DISPID_SRGIsPronounceable', 'DISPID_SBSFormat',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'ISpeechAudio', 'ISpLexicon',
    'IEnumString', 'SP_VISEME_12', 'SpeechVisemeFeature',
    'eLEXTYPE_PRIVATE5', 'SGLexicalNoSpecialChars',
    'DISPID_SWFEAvgBytesPerSec', 'SVSFParseMask',
    'DISPID_SVAudioOutputStream', 'ISpeechRecoResult',
    'SVESentenceBoundary', 'DISPID_SABIEventBias',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SPCLangId',
    'SpeechUserTraining', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SPPsItem', 'DISPID_SRGCommit', 'DISPID_SLPsCount',
    'SAFT22kHz8BitMono', 'SpStream', 'DISPID_SVPause',
    'DISPID_SLRemovePronunciation', 'DISPID_SGRAttributes',
    'SRAInterpreter', 'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SAVolume',
    'DISPID_SGRSTPropertyId', 'ISpeechRecognizerStatus',
    'SREAudioLevel', 'ISpeechVoiceStatus', 'ISpeechObjectToken',
    'SpeechCategoryAudioOut', 'SVP_10', 'DISPID_SLPLangId',
    'SPCT_SUB_DICTATION', 'SP_VISEME_21', 'DISPID_SRRTimes',
    'DISPIDSPTSI_ActiveOffset', 'SPRST_ACTIVE', 'DISPID_SGRSTsItem',
    'eLEXTYPE_RESERVED6', 'DISPID_SPPParent',
    'DISPID_SVSInputSentencePosition', 'SVP_5', 'SVP_11', 'SPSLMA',
    '_SPAUDIOSTATE', 'SVP_20', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SOTGetAttribute', 'eLEXTYPE_PRIVATE9', 'DISPID_SGRSTRule',
    'SAFT8kHz16BitStereo', 'SpeechSpecialTransitionType',
    'SPSNotOverriden', 'SVP_12', 'DISPID_SRGCmdLoadFromMemory',
    'ISpeechRecoResult2', 'DISPID_SPPsCount', 'SpeechGrammarWordType',
    'eLEXTYPE_PRIVATE8', 'SP_VISEME_0', 'SGDSActiveUserDelimited',
    'DISPID_SRCERecognitionForOtherContext', 'SREStateChange',
    'DISPID_SBSWrite', 'SPEI_MAX_TTS', 'SPWF_SRENGINE',
    'ISpeechPhraseElement', 'SREAllEvents', 'DISPID_SPISaveToMemory',
    'SpeechCategoryRecognizers', 'SPDKL_DefaultLocation',
    'SP_VISEME_13', 'SPPARTOFSPEECH', 'DISPID_SPRuleName',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SGRInitialState',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SRRSetTextFeedback',
    'SpPhoneticAlphabetConverter', 'SPWORDPRONUNCIATION', 'SPAR_Low',
    'ISpGrammarBuilder', 'SGDisplay', 'SDTLexicalForm',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SRCEFalseRecognition',
    'DISPID_SPRFirstElement', 'DISPID_SWFEExtraData',
    'SpPhraseInfoBuilder', 'ISpEventSource',
    'DISPID_SVSInputWordLength', 'SAFT44kHz16BitStereo',
    'ISpStreamFormat', 'SPSHORTCUTPAIR',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SVP_14',
    'SPPS_Modifier', 'SECNormalConfidence',
    'DISPID_SPRuleEngineConfidence', 'ISpStreamFormatConverter',
    'DISPID_SPRText', 'SVP_17', 'DISPID_SRSSupportedLanguages',
    'DISPID_SLWType', 'SDA_One_Trailing_Space', 'DISPID_SMSADeviceId',
    'SSSPTRelativeToEnd', 'eLEXTYPE_PRIVATE1', 'SRADynamic',
    'SPEI_RESERVED3', 'SPEI_SR_BOOKMARK', 'DISPID_SpeechLexicon',
    'SPEI_RESERVED6', 'DISPID_SOTCId', 'eWORDTYPE_DELETED',
    'SPVPRI_NORMAL', 'SRSInactiveWithPurge', 'SVP_19',
    'SpeechVoiceEvents', 'SAFTGSM610_22kHzMono',
    'DISPID_SVGetProfiles', 'SSFMCreateForWrite',
    'DISPID_SRRTOffsetFromStart', 'SPPS_RESERVED1', 'SRATopLevel',
    'SpeechAddRemoveWord', 'SPSFunction', 'DISPID_SRRGetXMLResult',
    'SAFTCCITT_uLaw_22kHzStereo', 'SpeechRecognizerState',
    'DISPID_SABIBufferSize', 'SAFT8kHz8BitStereo',
    'SpeechGrammarTagDictation', '_ISpeechVoiceEvents',
    'SAFTADPCM_22kHzStereo', 'SECLowConfidence',
    'DISPIDSPTSI_ActiveLength', 'SP_VISEME_1', 'SpeechInterference',
    'SpMMAudioOut', 'SECHighConfidence', 'ISpeechResourceLoader',
    'SAFT22kHz16BitMono', 'SAFT11kHz8BitMono', 'SAFTADPCM_8kHzMono',
    'SVP_7', 'DISPID_SVEEnginePrivate', 'DISPID_SpeechPhraseInfo',
    'SPADAPTATIONRELEVANCE', 'ISpRecoResult', 'ISpeechRecoGrammar',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SRRDiscardResultInfo',
    'SpeechPropertyNormalConfidenceThreshold',
    'SREPropertyStringChange', 'SPSHORTCUTPAIRLIST',
    'DISPID_SOTGetStorageFileName', 'DISPID_SpeechPhraseRules',
    'ISpeechXMLRecoResult', 'DISPID_SPRules_NewEnum',
    'eLEXTYPE_RESERVED8', 'SWTDeleted', 'SPDKL_CurrentConfig',
    'SDKLDefaultLocation', 'ISequentialStream',
    'DISPID_SpeechMMSysAudio', 'DISPID_SpeechFileStream',
    'SPWORDPRONOUNCEABLE', 'DISPID_SPEActualConfidence',
    'Speech_Max_Word_Length', 'DISPID_SOTIsUISupported',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SVSRunningState', 'SVPAlert',
    'SBONone', 'DISPID_SGRSAddRuleTransition', 'SpNullPhoneConverter',
    'ISpeechGrammarRule', 'DISPID_SGRSTPropertyValue',
    'SPEI_PHRASE_START', 'ISpeechPhraseInfoBuilder',
    'DISPID_SPEPronunciation', 'DISPID_SVEVoiceChange',
    'DISPID_SRCERequestUI', 'STCInprocServer', 'DISPID_SLPs_NewEnum',
    'SGRSTTEpsilon', 'SPXRO_Alternates_SML',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPAR_High', 'SAFT32kHz8BitMono',
    'DISPID_SRSClsidEngine', 'DISPID_SRCBookmark', 'SSFMOpenForRead',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SGRs_NewEnum',
    'SPCT_DICTATION', 'DISPID_SPPs_NewEnum',
    'DISPID_SRCERecognizerStateChange', 'SpPhoneConverter',
    'DISPID_SPRDisplayAttributes', 'SPAS_CLOSED',
    'SAFTCCITT_ALaw_44kHzStereo', 'SpeechAudioState',
    'DISPID_SGRSTPropertyName', 'DISPID_SPERetainedStreamOffset',
    'SBOPause', 'SPAR_Unknown', 'DISPID_SRState', 'DISPID_SRStatus',
    'SP_VISEME_10', 'DISPID_SGRsCount', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SVEStreamStart', 'DISPID_SRAudioInput',
    'SRTExtendableParse', 'eWORDTYPE_ADDED',
    'DISPID_SPERequiredConfidence', 'DISPID_SVEPhoneme',
    'SpFileStream', 'SVP_2', 'ISpeechPhraseInfo',
    'DISPID_SDKDeleteKey', 'SpObjectToken', 'DISPID_SVSLastResult',
    'SpeechTokenIdUserLexicon', 'DISPID_SVSLastBookmark', 'SPSVerb',
    'SRESoundStart', 'SVEAllEvents', 'IInternetSecurityManager',
    'DISPID_SPIEnginePrivateData', 'SGRSTTWildcard', 'SP_VISEME_15',
    'SPEI_MAX_SR', 'SPCT_COMMAND', 'SPRECORESULTTIMES',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SRTStandard',
    'DISPID_SDKSetBinaryValue', 'ISpPhoneConverter',
    'DISPID_SDKOpenKey', 'SAFT48kHz16BitStereo',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SGRClear', 'SPAO_NONE',
    'SPEI_END_SR_STREAM', 'SGSExclusive', 'DISPIDSPTSI',
    'SDA_Consume_Leading_Spaces', 'DISPID_SPAs_NewEnum', 'SPSMF_UPS',
    'SP_VISEME_3', 'SPEI_ADAPTATION', 'SP_VISEME_8',
    'SPRECOCONTEXTSTATUS', 'SPBO_PAUSE', 'SAFTADPCM_11kHzMono',
    'SVP_16', 'SVSFDefault', 'DISPID_SVSLastStreamNumberQueued',
    'SAFTCCITT_uLaw_8kHzMono', 'SPGRAMMARWORDTYPE',
    'DISPID_SRGSetWordSequenceData',
    'SpeechPropertyLowConfidenceThreshold', 'ISpShortcut',
    'SRSInactive', 'SVSFNLPSpeakPunc', 'SVP_9', 'SPRS_INACTIVE',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SpeechMemoryStream',
    'DISPID_SpeechRecoResult2', 'SDTAudio', 'DISPID_SPEsItem',
    'IStream', 'DISPID_SRCVoicePurgeEvent', 'SAFTADPCM_44kHzMono',
    'SpeechVisemeType', 'SPBO_NONE', 'SAFT44kHz8BitStereo',
    'SPWORDLIST', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SpeechPhraseReplacement', 'SVSFPurgeBeforeSpeak',
    'DISPID_SRGetPropertyString', 'DISPID_SRCRetainedAudio', 'SVP_1',
    'SPVPRIORITY', 'ISpObjectWithToken', 'SRARoot',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SRGDictationSetState',
    'DISPID_SpeechVoiceStatus', 'DISPID_SPPFirstElement',
    'DISPID_SVEAudioLevel', 'DISPID_SPRulesCount', 'SP_VISEME_2',
    'SPWORDTYPE', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SpeechVoice', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SASNonBlockingIO', 'SPRULE', 'SpeechCategoryRecoProfiles',
    'DISPID_SFSClose', 'SPCONTEXTSTATE', 'DISPID_SpeechRecoResult',
    'DISPID_SRGetRecognizers', 'SAFT16kHz8BitMono', 'SRSEIsSpeaking',
    'DISPID_SAFGetWaveFormatEx', 'SAFT24kHz16BitMono',
    'DISPID_SLWs_NewEnum', 'DISPID_SLGenerationId', 'DISPID_SLPType',
    'SPAUDIOBUFFERINFO', 'eLEXTYPE_PRIVATE14', 'DISPID_SRGId',
    'SVSFVoiceMask', 'DISPID_SVESentenceBoundary', 'DISPID_SLWLangId',
    'eLEXTYPE_APP', 'DISPID_SRCEHypothesis', 'SPEI_TTS_PRIVATE',
    'Speech_StreamPos_Asap', 'SPPS_NotOverriden',
    'DISPID_SVAlertBoundary', 'SpeechRegistryUserRoot', 'SFTSREngine',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SPEDisplayAttributes', 'SGSDisabled', 'SPEI_HYPOTHESIS',
    'SPCATEGORYTYPE', 'SpeechGrammarTagWildcard', 'DISPID_SGRId',
    'SpeechRuleAttributes', 'DISPID_SOTs_NewEnum', 'SVSFIsNotXML',
    'ISpeechPhraseProperty', 'SPSNoun',
    'SpeechDictationTopicSpelling', 'DISPID_SRCEAudioLevel',
    'DISPID_SDKSetLongValue', 'SpeechRuleState',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SFSOpen', 'SVP_13',
    'SVP_21', 'DISPID_SVStatus', 'SPEI_RECO_STATE_CHANGE',
    'SGRSTTDictation', 'DISPID_SPPNumberOfElements', 'SPEI_VISEME',
    'DISPID_SRCreateRecoContext', 'eLEXTYPE_PRIVATE11',
    'DISPID_SpeechPhraseProperty', 'ISpeechRecoResultDispatch',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SpeechVoiceEvent', 'DISPID_SOTsItem',
    'SpeechGrammarRuleStateTransitionType', 'SAFT12kHz16BitStereo',
    'DISPID_SRRSpeakAudio', 'SPEI_RESERVED1', 'SAFT22kHz8BitStereo',
    'DISPID_SGRsDynamic', 'SpeechStreamFileMode',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SOTDataKey',
    'SRCS_Enabled', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SRCEPhraseStart', 'ISpeechBaseStream',
    'eLEXTYPE_LETTERTOSOUND', 'eLEXTYPE_MORPHOLOGY', 'SPWF_INPUT',
    'ISpeechObjectTokens', 'DISPID_SMSALineId', 'ISpResourceManager',
    'SPSHT_OTHER', 'SREAdaptation', 'SPPHRASEREPLACEMENT',
    'SPRST_INACTIVE', 'DISPID_SRCAudioInInterferenceStatus',
    'SPINTERFERENCE_TOOQUIET', 'ISpSerializeState',
    'SAFT12kHz8BitStereo', 'SPEI_START_SR_STREAM',
    'SpeechTokenContext', 'SPGS_EXCLUSIVE', 'DISPID_SADefaultFormat',
    'DISPID_SGRSTransitions', 'eLEXTYPE_PRIVATE20', 'DISPID_SAFGuid',
    'SGRSTTWord', 'DISPID_SVSpeakCompleteEvent', 'SpeechPartOfSpeech',
    ...
    'DISPID_SOTSetId', 'DISPID_SVSInputWordPosition', 'SPLOADOPTIONS',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SRCEBookmark',
    'STSF_LocalAppData', 'SP_VISEME_9', 'DISPID_SpeechRecoContext',
    'DISPID_SOTRemove', 'DISPID_SOTCDefault', 'DISPID_SVGetVoices',
    'DISPID_SLAddPronunciationByPhoneIds', 'SGRSTTTextBuffer',
    'SpShortcut', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SPIAudioSizeBytes', 'SPRULESTATE', 'SAFT48kHz16BitMono',
    'SINoSignal', 'SAFT8kHz16BitMono', 'DISPID_SpeechXMLRecoResult',
    'SDTAlternates', 'SRTAutopause', 'SPPS_Noncontent',
    ...
    'SPEI_RECOGNITION', 'ISpeechWaveFormatEx', 'SREPhraseStart',
    'SPPROPERTYINFO', 'SDTAll', 'SGPronounciation',
    'eLEXTYPE_VENDORLEXICON', 'eLEXTYPE_RESERVED9', 'SPAUDIOSTATUS',
    'SAFT32kHz8BitStereo', 'SVSFParseSsml', 'IEnumSpObjectTokens',
    'ISpeechRecoResultTimes', 'DISPID_SLPSymbolic',
    'DISPID_SpeechAudioBufferInfo', 'SPEI_SR_PRIVATE',
    'DISPID_SOTsCount', 'SRAExport', 'SP_VISEME_19',
    'ISpeechCustomStream', 'DISPID_SRSNumberOfActiveRules',
    'SPPS_Interjection', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SPARecoResult', 'SECFIgnoreCase',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SPIGrammarId',
    'DISPID_SPRulesItem', 'DISPID_SPEDisplayText',
    'SDA_No_Trailing_Space', 'SITooLoud', 'DISPID_SDKEnumValues',
    'DISPID_SASetState', 'SAFT12kHz16BitMono', 'ISpXMLRecoResult',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SRGDictationUnload',
    'SPPS_RESERVED3', 'SpeechGrammarState', 'DISPID_SRCVoice',
    'DISPID_SpeechPhraseElements', 'SPCT_SLEEP', 'SVEPhoneme',
    'SPSHORTCUTTYPE', 'SPVISEMES', 'Speech_Default_Weight',
    'DISPID_SpeechDataKey', 'SAFT11kHz16BitStereo',
    'DISPID_SPEsCount', 'SREPropertyNumChange',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SVResume',
    'DISPID_SGRSRule', 'SPRST_NUM_STATES', 'DISPID_SRCEAdaptation',
    'ISpeechMMSysAudio', 'SPSHT_Unknown', 'SRTReSent',
    'DISPID_SGRsFindRule', 'SGSEnabled', 'SPRST_INACTIVE_WITH_PURGE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPVPRI_ALERT', 'SVP_6',
    'SRSEDone', 'ISpeechLexiconWords', 'DISPID_SGRAddState',
    'SP_VISEME_20', 'SVF_Emphasis', 'SpeechAllElements',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SRCRecognizer',
    'DISPID_SMSSetData', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SpeechObjectTokenCategory', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SPAPhraseInfo', 'DISPID_SLGetWords', 'SSTTDictation',
    'SVF_None', 'SpeechTokenShellFolder',
    ...
    'SAFT16kHz16BitStereo', 'SPBO_TIME_UNITS', 'DISPID_SAStatus',
    'SGDSActiveWithAutoPause',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SpeechEmulationCompareFlags', 'SPEI_MIN_SR', 'SFTInput',
    'SPWT_PRONUNCIATION', 'DISPID_SPIRule', 'ISpProperties',
    'DISPID_SGRSTWeight', 'SPPS_RESERVED4', 'ISpeechAudioBufferInfo',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SPACommit',
    'SpeechDataKeyLocation', 'DISPID_SpeechCustomStream',
    'SpeechVoiceSpeakFlags', 'SAFT24kHz16BitStereo', 'SGLexical',
    'ISpPhoneticAlphabetSelection', 'DISPID_SMSAMMHandle',
    ...
    'SPINTERFERENCE', 'SREHypothesis', 'SVEWordBoundary',
    'IInternetSecurityMgrSite', 'SpeechFormatType', 'SVEPrivate',
    'SVP_4', 'ISpeechPhraseElements', 'SPEI_RESERVED2',
    'DISPID_SpeechAudioStatus', 'DISPID_SASFreeBufferSpace',
    'SAFT32kHz16BitMono', 'DISPID_SVAudioOutput',
    'SpeechAudioProperties', 'SP_VISEME_5', 'SPPS_SuppressWord',
    'SpeechTokenKeyUI', 'DISPID_SRGRecoContext', 'ISpEventSink',
    'ISpeechMemoryStream', 'SAFTNoAssignedFormat',
    'SPFM_OPEN_READONLY', 'DISPID_SBSSeek',
    'SPEI_PROPERTY_STRING_CHANGE', 'SPGRAMMARSTATE',
    'DISPID_SPAsItem', 'SpCompressedLexicon', 'SPINTERFERENCE_NOISE',
    'DISPID_SpeechLexiconProns', 'DISPID_SRCEPropertyNumberChange',
    'SRAONone', 'DISPID_SPIStartTime', 'ISpRecoCategory',
    'DISPID_SPRNumberOfElements', 'SWTAdded', 'SAFTADPCM_11kHzStereo',
    'SPSEMANTICFORMAT', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SPPChildren', 'SpStreamFormatConverter',
    'DISPID_SRProfile', 'SDKLLocalMachine', 'DISPID_SGRSTsCount',
    'DISPID_SPPBRestorePhraseFromMemory', 'SP_VISEME_17',
    'DISPID_SLWPronunciations', 'SITooFast', 'SVPOver',
    'SPLEXICONTYPE', 'SVP_0', 'SVEStartInputStream', 'SP_VISEME_6',
    'DISPID_SRCRequestedUIType', 'SpeechPropertyComplexResponseSpeed',
    'SpLexicon', 'DISPID_SRCEInterference', 'eLEXTYPE_PRIVATE4',
    'SAFTExtendedAudioFormat', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SpeechRecoContextEvents', 'SpMMAudioEnum', 'SAFTText',
    'SPEI_INTERFERENCE', 'SINoise', 'SPFM_OPEN_READWRITE',
    'SpeechTokenValueCLSID', 'SPEI_PHONEME', 'DISPID_SRGetFormat',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SpeechAudioFormat',
    'eLEXTYPE_PRIVATE17', 'SLTUser', 'SPWT_DISPLAY',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SWFEBitsPerSample',
    'ISpPhrase', 'DISPID_SPPValue', 'SINone', 'SP_VISEME_18',
    'DISPID_SRCEventInterests', 'SP_VISEME_14', 'DISPID_SAFType',
    'SAFTGSM610_11kHzMono', 'SDTRule',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SRCRetainedAudioFormat',
    'SpInprocRecognizer', 'DISPID_SBSRead',
    'DISPID_SPERetainedSizeBytes', 'SSFMOpenReadWrite', 'SASRun',
    'eLEXTYPE_PRIVATE7', 'DISPID_SRRTLength', 'SVEBookmark',
    'SPEI_MIN_TTS', 'SpTextSelectionInformation',
    'DISPID_SVWaitUntilDone', 'SAFT11kHz16BitMono', 'SpMMAudioIn',
    'eLEXTYPE_RESERVED7', 'ISpeechPhoneConverter',
    'SpeechCategoryVoices', 'eLEXTYPE_PRIVATE2',
    'DISPID_SGRSAddWordTransition', 'SPBO_AHEAD',
    'DISPIDSPTSI_SelectionOffset', 'SPSHT_NotOverriden', 'STCAll',
    'DISPID_SRSAudioStatus', 'SREPrivate', 'SPWAVEFORMATTYPE',
    'ISpDataKey', 'SPEI_END_INPUT_STREAM', 'SITooQuiet',
    'DISPID_SGRAddResource', 'DISPID_SPPId', 'SPEI_SOUND_END',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SPEEngineConfidence',
    'SAFT12kHz8BitMono', 'ISpeechTextSelectionInformation',
    'SDKLCurrentUser', 'SDTProperty', 'ISpAudio', 'SPAS_RUN',
    'SSSPTRelativeToStart', 'SPPS_Function',
    'ISpeechLexiconPronunciations', 'ISpeechRecognizer',
    'DISPID_SRDisplayUI', 'SpeechCategoryAudioIn',
    'SPEI_WORD_BOUNDARY', 'SPLO_DYNAMIC', 'SVSFIsFilename',
    'SAFT44kHz8BitMono', 'DISPID_SRCESoundStart', 'DISPID_SRIsShared',
    'STSF_FlagCreate', 'SREStreamEnd', 'ISpRecoContext',
    'SP_VISEME_7', 'SPAS_STOP', 'DISPID_SRAudioInputStream',
    'SpeechMicTraining', 'DISPID_SRRTStreamTime',
    'SpeechVoiceSkipTypeSentence', 'SPVPRI_OVER', 'SPWORD',
    'SRERequestUI', 'DISPID_SVIsUISupported', 'DISPID_SGRSTText',
    'SAFTCCITT_uLaw_8kHzStereo',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPDKL_LocalMachine',
    'SpeechAudioFormatType', 'SpMemoryStream',
    'DISPID_SpeechPhraseElement', 'STCInprocHandler',
    'DISPID_SOTGetDescription', 'SVP_8', 'ISpeechAudioFormat',
    'ISpeechGrammarRuleStateTransition'
]

_check_version('1.2.0', 1700030983.722430)
