...
def get_sensorList():
    try:
        ...
        params = {
            ...
            'sql':"SELECT id AS uuid, name AS sensorName,uom AS UOM CASE WHEN UOM IS NOT NULL THEN UOM ELSE 'UOM' END AS uom FROM sensor WHERE id IN ({}) ORDER BY name".format(
