...
@router.route('/getPredDataHourly', methods=['POST'])
...
# @router.route('/getPredDataDaily', methods=['POST'])
...
@router.route('/getPredDataDailyV1', methods=['POST'])
...
@router.route('/getPredDataMonthly', methods=['POST'])
...
@router.route('/getPredDataDaily1', methods=['POST'])
...
@router.route('/getPredDataDaily2', methods=['POST'])
...
@router.route('/getPredDataDaily3', methods=['POST'])
...
'''========================================================JPDCL API======================================================================'''
@router.route('/get_sensorListV2', methods=['GET'])
def get_sensorListV2():
...
@router.route('/getPredDataDailyjpdcl', methods=['POST'])
def getPredDataDailyjpdcl():
    try:
        ...
        return {"rc": 0, "message": "Success",
                "pred_daily_sum": round(pred_daily_sum, 2),
                "pred_max_hour": pred_max_hour, "pred_max_value": pred_max_value,
                "data": response_data,
                "percentage": percent}
    ...
    try:
        ...
        def generate_batches():
            ...
            for batch in batches:
                ...
                # Yield the data as a JSON response
